...
const tempoararyTransactionsRoute = require("./routes/tempoararyTransactionsRoute");
...
const {
  interceptorParam,
  bruteForce,
} = require("./middleware/interceptorParam");

const dotenv = require("dotenv");
dotenv.config({ path: "./config/config.env" });
const config = require("config")
const { KEY, PROJECT_ID } = config.get("treblle");
// routes
...
app.use("/tempoararyTransaction", protect, tempoararyTransactionsRoute);
